...
class ProcessShowData():
    ...
    config = {
        ...
        'pre': {
            ...
            'ONLINE_URL': "http://192.168.2.165:8008/api/data/"
        }
    }
    ...
    def post_data(cls, data, op_type):
        ...
        response = requests.post(url,
                                 headers=headers, json=data, timeout=3600)
    ...
    @classmethod
    def list(cls, data):
        return cls.post_data(data, "list")
    ...
    def get_report(cls, file_name):
        ...
        # 发送GET请求
        response = requests.post(url, headers=headers, json=file_name)
...
if __name__ == "__main__":
    update_data = {
        ...
        "market": "US",
        "require": "list",
        "position": "CrawlerAsin",
        "type": "SP",
        "ID": "60",  # 具体的sku
        "text": "3",
        "user": "test"
    }
    res = ProcessShowData.list(update_data)
    print(res)
    # update_data = {
    #     "db": "amazon_ads",
    #     "brand": "LAPASA",
    ...
    #     "ID": ["sku1","sku2"],  # 具体的sku
    #     "text": " ",
    #     "campaignId": ["532741363543129","377421135440884"],
    #     "adGroupId": ["377421135440884","532741363543129"],
    #     "user": "test"
    # }
    # res = ProcessShowData.create(update_data)
    # 要发送的JSON数据
    # update_data = {
    #     "db":"amazon_ads",
    #     "brand": "LAPASA",
    ...
    #     "position": "keyword",
    #     "type": "SP",
    #     "ID": "lapasa men's fleece lined thermal underwear set ",
    #     "text": "0.4560",
    #     "user":"wanghequan",
    #     "campaignId":"72044194881042",
    #     "adGroupId":"206579102356022",
    #     "matchType":"BROAD"
    # }
    #
    ...
    #     "type": "SP",
    #     "ID": ["B09DCXYTVM", "B09DCXYTVM"],  # 可以是词或者ASIN
    #     "text": ["0.5","0.4"],
    #     "campaignId": ["557406104552282", "557406104552282"],
    #     "adGroupId": ["301331981239468", "301331981239468"],
    ...
    #     "type": "SP",
    #     "ID": "B09DCXYTVM",  # 可以是词或者ASIN
    #     "text": "0.4",
    #     "campaignId": "557406104552282",
    #     "adGroupId": "301331981239468",
    #     "matchType": "ASIN_SAME_AS",  # NEGATIVE_PHRASE 如果添加的是asin则需要传"asin"
    #     "user": "wanghequan"
    # }
    # res = ProcessShowData.update(update_data)
    # # 添加否定关键词和商品（自动判定）
